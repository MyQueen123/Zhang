<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommentManager.aspx.cs" Inherits="NET55.Sisyphus.Web.Admin.Page.CommentManager" %>
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block">
                            <li>
                                ...
                                <a href="CommentManager.aspx" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>评论列表</span>
                                </a>
                        </ul>
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="CommentManager.aspx">评论管理</a></li>
            </ol>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-author am-hide-sm-only">被评书籍</th>
                                            <th class="table-set">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%foreach (var item in BookCommentList)
                                          {
                                        %>
                                        <tr>
                                            <td><%=item.Id %></td>
                                            <td><a href="#"><%=item.Msg %></a></td>
                                            <td class="am-hide-sm-only"><%=item.CreateDateTime.ToString("yyyy-MM-dd") %></td>
                                            <td><a href="#"><%=uBll.GetModel(item.BookId).Title %></a></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-gear am-icon-spin"></span>点亮</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
