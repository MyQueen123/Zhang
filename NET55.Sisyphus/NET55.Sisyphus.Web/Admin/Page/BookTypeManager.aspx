<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookTypeManager.aspx.cs" Inherits="NET55.Sisyphus.Web.Admin.Page.BookTypeManager" %>
        ...
        $(function () {
            ...
            $('button[name="btn"]').click(function () {
                swal({
                    ...
                    inputPlaceholder: "请输入的类型"
                },
               function (inputValue) {
                   if (inputValue === false) return false;

                   if (inputValue === "") {
                       swal.showInputError("您还没有输入要添加的类型哦！");
                       return false
                   }
                   $.post('/Admin/Ashx/AddTypeName.ashx', { typeName: inputValue }, function (msg) {
                       if (msg == "ok") {
                           swal({
                               title: '您已成功添加该类型',
                               type: 'success'
            ...
            $('a[name="edit"]').click(function () {
                //获取用户选择的ID
                var typeName = $(this).prev().val();
                var typeid = $(this).next().next().val();
                var typeNa = $(this).parent().parent().parent().prev();
                swal({
                    title: "修改！",
                    text: "请输入您要修改的类型名称：",
                    type: "input",
                ...
                function (inputValue) {
                    ...
                    if (inputValue === "") {
                        swal.showInputError("您还没有输入要修改的名称哦！");
                        return false
                    }
                    $.post('/Admin/Ashx/updateTypeName.ashx', { typeid: typeid, typeName: inputValue }, function (msg) {
                        if (msg == "ok") {
                            swal("提示！", "您已成功修改该类型", "success");
                            typeNa.text(inputValue);
                        }
                    });
                });
            });
            ...
            $('a[name="delete"]').click(function () {
                ...
                swal({
                    ...
                    $.post('/Admin/Ashx/DeleteBookTypeManager.ashx', { typeid: typeid }, function (msg) {
                        if (msg == "no") {
                            sweetAlert("提示", "对不起，该类型下有书籍，不能删除！", "error");
                        } else if (msg == "ok") {
                            $("#" + typeid).remove();
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
                ...
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block">
                            <li>
                                <a href="BookTypeManager.aspx" class="active">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="BookTypeManager.aspx">书籍类型管理</a></li>
            </ol>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<%=item.Id %>">
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <input type="hidden" name="typrid" value="<%=item.Name %>" />
                                                        <a class="am-btn am-btn-default  am-btn-xs am-text-danger" name="edit"><span class="am-icon-edit"></span>编辑</a>
                                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" name="delete"><span class="am-icon-trash-o"></span>删除</a>
                                                        <input type="hidden" name="typrid" value="<%=item.Id %>" />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
