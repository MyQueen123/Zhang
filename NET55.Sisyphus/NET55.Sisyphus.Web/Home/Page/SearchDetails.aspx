<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchDetails.aspx.cs" Inherits="NET55.Sisyphus.Web.Home.Page.SearchDetails" %>
...
<head>
    ...
    <script>
        function LoadBooks() {
            var zhi = $('#zi').val();
            $('#searchul').empty();
            $.post('/Home/Ashx/BookDetails.ashx', { zi: zhi }, function (data) {

                $.each(data, function (i, v) {
                    $('<li><div class="i-pic limit"><img src="/BookCovers/' + v.ISBN + '.jpg" /><p class="title fl">' + v.Title + '</p><p class="price fl"><b>¥</b><strong>' + v.UnitPrice + '</strong></p><p class="number fl">销量<span>1110</span></p></div></li>').appendTo($('#searchul'));
                });
            }, 'json');
        }
        ...
        $(function () {
            $('#ai-topsearch').click(function () {
                var selfPage = $('#searchInput').val();
                window.location.href = "/Home/Page/SearchDetails.aspx?zi=" + selfPage;
            });
...
<body>
    ...
    <div class="nav white">
        ...
        <div class="search-bar pr">
            ...
            <form>
                <input type="hidden" id="zi" name="wantknow" value="<%=searchWord %>" />
                <input id="searchInput" name="index_none_header_sysc" type="text" placeholder="搜索" autocomplete="off" required>
            ...
            <div class="am-g am-g-fixed">
                <div class="am-u-sm-12 am-u-md-12">
                    <div class="theme-popover">
                        ...
                        <ul class="select">
                            <p class="title font-normal">
                                <span class="total fl">共搜索到<strong class="num">997</strong>件相关商品</span>
                            </p>
                            <div class="clear"></div>
                    ...
                    <div class="search-content">
                        ...
                        <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes" id="searchul">
