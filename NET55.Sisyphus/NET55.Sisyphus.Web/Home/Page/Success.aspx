<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Success.aspx.cs" Inherits="NET55.Sisyphus.Web.Home.Page.Success" %>
...
<body>
    ...
    <div class="nav white">
        <div class="logo">
            <img src="/BookCovers/logo.png" /></div>
        <div class="logoBig">
            <li>
    ...
    <div class="take-delivery">
        <div class="status">
            ...
            <div class="successInfo">
                <ul>
                    <li>付款金额<em>¥<%=od.TotalPrice.ToString("f2") %></em></li>
                    <div class="user-info">
                        <p>收货人：<%=uab.GetModel(Convert.ToInt32(od.PostAddress)).Name %></p>
                        <p>联系电话：<%=uab.GetModel(Convert.ToInt32(od.PostAddress)).Phone %></p>
                        <p>收货地址：<%=uab.GetModel(Convert.ToInt32(od.PostAddress)).Address %></p>
                    </div>
                ...
                <div class="option">
                    ...
                    <a href="../person/order.aspx" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
                    <a href="../person/orderinfo.aspx?orderId=<%=Request["orderId"] %>" class="J_MakePoint">查看<span>交易详情</span></a>
                </div>
            </div>
        </div>
    </div>
