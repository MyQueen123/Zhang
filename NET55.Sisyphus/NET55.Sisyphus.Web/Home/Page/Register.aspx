<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="NET55.Sisyphus.Web.Home.Register" %>
            ...
            $('#sub').click(function () {
                ...
                if ($('#frm').validator('isFormValid')) {
                    if ($('#Checkbox1').prop('checked')) {
                        $.post('/Home/Ashx/AddUsers.ashx', { telphone: $('#phone').val(), pwd: $('#password1').val(), repwd: $('#password2').val(), yan: $('#code').val() }, function (msg) {
                            if (msg == "ok") {
                        ...
                        <div class="am-tab-panel">
                            <form id="frm" method="post" data-am-validator>
                                ...
                                <div class="user-pass">
                                    ...
                                    <input type="password" name="pwd" id="password1" placeholder="设置密码" minlength="6" maxlength="16" required />
                                </div>
                                <div class="user-pass">
                            ...
                            <div class="login-links">
                                <label for="reader-me">
                                    <input id="Checkbox1" type="checkbox" value="asd">
                                    点击表示您同意商城《服务协议》
                                </label>
                            </div>
                            <div class="am-cf">
                                <input type="submit" name="" disabled="disabled" id="sub" value="注册" class="am-btn am-btn-primary am-btn-sm am-fl">
                            </div>
