...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.UserInfoDal dal=new Maticsoft.DAL.UserInfoDal();
		public UserInfoBll()
		{}
		#region  BasicMethod
        ...
        public UserInfo GetModel(string admin, string pwd)
        {
            return dal.GetModel(admin,pwd);
        }
    }
}
