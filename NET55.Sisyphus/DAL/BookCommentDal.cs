...
namespace Maticsoft.DAL
{
	...
	public partial class BookCommentDal
	{
		...
		public Maticsoft.Model.BookComment GetModel(int Id)
		{
			...
			Maticsoft.Model.BookComment model=new Maticsoft.Model.BookComment();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.BookComment DataRowToModel(DataRow row)
		{
			Maticsoft.Model.BookComment model=new Maticsoft.Model.BookComment();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.CreateDateTime desc");
			}
