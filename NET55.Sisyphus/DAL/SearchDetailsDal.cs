...
namespace Maticsoft.DAL
{
	...
	public partial class SearchDetailsDal
	{
		...
		public bool Add(Maticsoft.Model.SearchDetails model)
		{
			...
			strSql.Append("KeyWords,SearchDateTime)");
		...
		public Maticsoft.Model.SearchDetails GetModel(Guid Id)
		{
			...
			Maticsoft.Model.SearchDetails model=new Maticsoft.Model.SearchDetails();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.SearchDetails DataRowToModel(DataRow row)
		{
			Maticsoft.Model.SearchDetails model=new Maticsoft.Model.SearchDetails();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.SearchDateTime desc");
			}
