...
namespace Maticsoft.DAL
{
	...
	public partial class OrdersDal
	{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.OrderDate desc");
			}
        ...
        {
            string sql = "update Orders set PostAddress='"+p+"' where OrderId='"+orderId+"'";
        ...
        public bool UpdateToDelete(string OrderId)
        {
            ...
            string sql = "update Orders set state=2 where OrderId=@orderId";
            SqlParameter[] parameters = {
					new SqlParameter("@OrderId", SqlDbType.NVarChar,50)			};
            parameters[0].Value = OrderId;
